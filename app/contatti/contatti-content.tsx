  ...
  return (
    <div className="min-h-screen font-sans text-white" style={{ backgroundColor: '#3D65C6' }}>
      ...
      <main className="mx-auto max-w-3xl px-4 py-10 md:py-14">
        ...
        <h1 className="mb-8 font-display text-2xl font-bold text-white md:text-3xl">{t('contact.title')}</h1>
        ...
        <div className="space-y-8">
          <section className="flex gap-4 rounded-xl border border-white/20 bg-white/10 p-6">
            ...
            <div>
              <h2 className="mb-2 font-semibold text-white">{t('contact.emailTitle')}</h2>
              <p className="mb-2 text-sm text-white/80">{t('contact.emailDesc')}</p>
              <a
          ...
          <section className="flex gap-4 rounded-xl border border-white/20 bg-white/10 p-6">
            ...
            <div>
              <h2 className="mb-2 font-semibold text-white">{t('contact.sellerTitle')}</h2>
              <p className="mb-2 text-sm text-white/80">{t('contact.sellerDesc')}</p>
              <a
