...
export default function CookiePage() {
  return (
    <LegalDocShell titleKey="legal.cookie.title" lastUpdated={TERMS_LAST_UPDATED}>
      <section>
        <h2 className="mb-2 text-lg font-semibold text-white">1. Titolare</h2>
        <p className="mb-4">
      ...
      <section>
        <h2 className="mb-2 text-lg font-semibold text-white">2. Cosa sono i cookie</h2>
        <p>
      ...
      <section>
        <h2 className="mb-2 text-lg font-semibold text-white">3. Tipi di cookie utilizzati</h2>
        <p>
      ...
      <section>
        <h2 className="mb-2 text-lg font-semibold text-white">4. Gestione e revoca</h2>
        <p>
      ...
      <section>
        <h2 className="mb-2 text-lg font-semibold text-white">5. Cookie di terze parti</h2>
        <p>
