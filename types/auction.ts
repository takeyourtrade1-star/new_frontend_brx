...
export interface AuctionCreatePayload {
  ...
  shipping_eu_default_eur?: number | null;
  shipping_country_prices?: { country_iso: string; price_eur: number }[];
  /* NB: anti_sniper_enabled / anti_sniper_minutes NON vanno inviati in
   * creazione: il backend li rifiuta con 422 "Extra inputs are not permitted"
   * e applica la propria configurazione anti-snipe. Restano leggibili nelle
   * risposte (vedi AuctionAPI). */
