...
export const FIGHT_TOTAL_MS = 3200;
/** Chiave sessionStorage: la lotta parte al massimo una volta per sessione. */
export const FIGHT_SESSION_KEY = 'brx_asso_fight_v1';
