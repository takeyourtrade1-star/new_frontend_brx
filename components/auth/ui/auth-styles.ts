/** Token Tailwind condivisi per tutte le schermate auth. */
...
/** Card più larga per la landing demo /login con form integrato. */
export const AUTH_CARD_DEMO_CLASS =
  'relative w-full max-w-[600px] mx-auto overflow-hidden animate-auth-enter rounded-[40px] bg-white/85 backdrop-blur-[60px] shadow-[0_32px_64px_rgba(0,0,0,0.1),inset_0_1px_1px_rgba(255,255,255,0.8)] border border-white/50';
...
/** Input più grandi per il pannello login demo (colonna destra). */
export const AUTH_LANDING_INPUT_CLASS =
  'h-[4.25rem] w-full rounded-2xl border border-black/10 bg-black/5 px-5 text-[16px] text-[#1d1d1f] placeholder:text-[#86868b] focus:outline-none focus:border-global-bg-start focus:ring-2 focus:ring-global-bg-start/25 transition-all disabled:opacity-50';

/** Card form login demo — colonna destra, più ampia. */
export const AUTH_CARD_LOGIN_PANEL_CLASS =
  'relative w-full max-w-[580px] overflow-hidden animate-auth-enter rounded-[40px] bg-white/90 backdrop-blur-[60px] shadow-[0_32px_64px_rgba(0,0,0,0.12),inset_0_1px_1px_rgba(255,255,255,0.8)] border border-white/50';
