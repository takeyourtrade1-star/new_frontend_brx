  ...
  return (
    <>
      <header
        ...
        className="fixed top-0 left-0 right-0 z-[100] w-full font-sans text-white bg-[#1D3160]"
      >
      {/* Top bar */}
      <div className="relative z-20 w-full pb-0" style={{ backgroundColor: '#1D3160' }}>
      ...
      <div className="relative z-10 w-full overflow-visible pt-0" style={{ backgroundColor: '#1D3160' }}>
