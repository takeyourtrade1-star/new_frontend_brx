...
const ORANGE_GLASS_CART_CLASS =
  'hidden md:block absolute left-1/2 top-full z-[120] mt-1.5 min-w-[280px] -translate-x-1/2 rounded-2xl border border-primary/45 bg-primary/30 px-0 py-0 text-white backdrop-blur-2xl backdrop-saturate-150 shadow-2xl ring-1 ring-white/20 animate-orange-menu-enter';
          ...
          <div className="flex items-center justify-between border-b border-white/20 px-4 py-3">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-medium">
                {cartCount === 1
                  ? t('cart.itemsOne', { count: cartCount })
