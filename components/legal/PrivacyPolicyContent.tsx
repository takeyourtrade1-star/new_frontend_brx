    ...
    <>
      ...
      <LegalSection>
        ...
        <P>
          ...
          <LegalInlineLink href="/legal/condizioni">
      ...
      <LegalSection>
        ...
        <P>
          ...
          <LegalInlineLink href="/legal/cookie">
            Cookie Policy
          </LegalInlineLink>
          .
        </P>
      ...
      <LegalSection>
        ...
        <LegalTable>
          <LegalTableHead>
            <tr>
              <LegalTableTh>Finalità</LegalTableTh>
              <LegalTableTh>Base giuridica</LegalTableTh>
              <LegalTableTh>Conferimento</LegalTableTh>
            </tr>
          </LegalTableHead>
          <LegalTableBody>
            <tr>
              <LegalTableTd>Registrazione, autenticazione e gestione dell&apos;account</LegalTableTd>
              <LegalTableTd>Esecuzione del contratto (art. 6.1.b GDPR)</LegalTableTd>
              <LegalTableTd>Necessario</LegalTableTd>
            </tr>
            <tr>
              <LegalTableTd>Erogazione dei servizi di mercato, aste, ordini e messaggistica</LegalTableTd>
              <LegalTableTd>Esecuzione del contratto (art. 6.1.b GDPR)</LegalTableTd>
              <LegalTableTd>Necessario</LegalTableTd>
            </tr>
            <tr>
              <LegalTableTd>Sincronizzazione inventari con piattaforme terze</LegalTableTd>
              <LegalTableTd>Esecuzione del contratto (art. 6.1.b GDPR)</LegalTableTd>
              <LegalTableTd>Facoltativo ma necessario per il servizio Sync</LegalTableTd>
            </tr>
            <tr>
              <LegalTableTd>Motore di ricerca, indicizzazione e personalizzazione dell&apos;esperienza</LegalTableTd>
              <LegalTableTd>Legittimo interesse (art. 6.1.f GDPR)</LegalTableTd>
              <LegalTableTd>Automatico con l&apos;uso del servizio</LegalTableTd>
            </tr>
            <tr>
              <LegalTableTd>Sicurezza, prevenzione frodi, antifrode e tutela della Piattaforma</LegalTableTd>
              <LegalTableTd>Legittimo interesse (art. 6.1.f GDPR)</LegalTableTd>
              <LegalTableTd>Automatico</LegalTableTd>
            </tr>
            <tr>
              <LegalTableTd>Adempimenti di legge, contabili e fiscali</LegalTableTd>
              <LegalTableTd>Obbligo di legge (art. 6.1.c GDPR)</LegalTableTd>
              <LegalTableTd>Necessario ove applicabile</LegalTableTd>
            </tr>
            <tr>
              <LegalTableTd>Comunicazioni di servizio, aggiornamenti tecnici e assistenza</LegalTableTd>
              <LegalTableTd>Esecuzione del contratto / legittimo interesse</LegalTableTd>
              <LegalTableTd>Necessario per il rapporto contrattuale</LegalTableTd>
            </tr>
            <tr>
              <LegalTableTd>Cookie analitici o di profilazione non strettamente necessari</LegalTableTd>
              <LegalTableTd>Consenso (art. 6.1.a GDPR)</LegalTableTd>
              <LegalTableTd>Facoltativo</LegalTableTd>
            </tr>
            <tr>
              <LegalTableTd>Marketing diretto, newsletter o comunicazioni promozionali</LegalTableTd>
              <LegalTableTd>Consenso (art. 6.1.a GDPR) o legittimo interesse ove ammesso</LegalTableTd>
              <LegalTableTd>Facoltativo</LegalTableTd>
            </tr>
            <tr>
              <LegalTableTd>Test tecnico e miglioramento della versione Demo/Beta</LegalTableTd>
              <LegalTableTd>Legittimo interesse / esecuzione del contratto</LegalTableTd>
              <LegalTableTd>Inerente all&apos;uso della fase Demo</LegalTableTd>
            </tr>
          </LegalTableBody>
        </LegalTable>
      ...
      <LegalSection>
        ...
        <P>
          ...
          tornei (es.{' '}
          <LegalInlineLink href="https://tornei.ebartex.com" external>
            tornei.ebartex.com
          </LegalInlineLink>
      ...
      <LegalSection>
        ...
        <P>
          ...
          <LegalInlineLink href="https://www.garanteprivacy.it" external>
      ...
      <LegalSection>
        ...
        <Ul>
          ...
          <li>
            <LegalInlineLink href="/legal/norme">
              Norme legali
            </LegalInlineLink>
          </li>
          <li>
