// Dati pesanti del guardaroba mascotte (stringhe SVG): CLOTHING/ACCESSORY/OBJECT.
// Separati da mascotte-wardrobe.ts (tipi + costanti leggere + helper di stile) per
// isolare ~1850 righe di SVG. Nessun cambio di comportamento: i consumer importano
// gli array da qui, tipi/costanti/helper restano in ./mascotte-wardrobe.
import type { WardrobeItem } from './mascotte-wardrobe';
...
export const ACCESSORY_ITEMS: WardrobeItem[] = [
  ...
  },
  {
    ...
    svg: `<svg viewBox="0 0 130 58" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <!-- Main conical body (filter narrow â†’ widens â†’ tip) -->
      <path d="M 78 20 
