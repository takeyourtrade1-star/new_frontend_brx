...
export const MOCK_AUCTIONS: AuctionMock[] = [
  ...
  /** Aste MTG concluse collegate a mock spedizioni (vedi mock-auction-shipping.ts). */
  {
    ...
    reservePriceEur: 10000,
    status: 'ended',
    winnerUsername: 'VintageVault_DE',
  },
  {
    id: 'c4',
    ...
    currentBidEur: 2850,
    bidCount: 31,
    seller: 'PowerNineVault',
    sellerCountry: 'FR',
    sellerRating: 100,
    sellerReviewCount: 512,
    game: 'mtg',
    startingBidEur: 1200,
    reservePriceEur: 2200,
    status: 'ended',
    winnerUsername: 'PowerNine_FR',
  },
  {
    id: 'c5',
  ...
  },
  {
    ...
    game: 'mtg',
    startingBidEur: 1500,
    reservePriceEur: 2800,
    status: 'ended',
    winnerUsername: 'DualLand_Collector',
  },
  {
    id: 'c8',
    ...
    currentBidEur: 4800,
    bidCount: 19,
    seller: 'OldSchoolCards',
    sellerCountry: 'US',
    sellerRating: 99,
    sellerReviewCount: 890,
    game: 'mtg',
    startingBidEur: 2500,
    reservePriceEur: 4200,
    status: 'ended',
    winnerUsername: 'OldSchool_MTG',
  },
  {
    id: 'c9',
