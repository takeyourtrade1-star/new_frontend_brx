  ...
  return (
    <div className="space-y-2">
      ...
      <button
        ...
        className="flex w-full min-h-[44px] items-center justify-center gap-2 rounded-xl border border-gray-200 bg-white px-4 py-2.5 text-sm font-semibold text-gray-800 shadow-sm active:scale-[0.99] disabled:opacity-50"
      >
        ...
        <span className="ml-auto text-xs font-medium tabular-nums text-gray-400">
