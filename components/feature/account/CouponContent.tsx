        ...
        <div className="mx-auto flex max-w-3xl flex-wrap items-end justify-center gap-20">
          <div className="w-36 shrink-0">
            ...
            <div className="relative flex h-10 items-center rounded-none bg-gray-200 px-4 py-2">
              ...
              >
                <option value="redeemed">{t('accountPage.couponRedeemed')}</option>
                <option value="all">{t('accountPage.couponFilterAll')}</option>
                <option value="not">{t('accountPage.couponNotRedeemed')}</option>
              </select>
