...
export function FeaturesSection() {
  ...
  const features = useMemo(
    () =>
      [
        { titleKey: 'gameHome.features.bestPrices' as const, Icon: IconPrezziMigliori },
        { titleKey: 'gameHome.features.fastShipping' as const, Icon: IconSpedizioniVeloci },
        { titleKey: 'gameHome.features.buyerProtection' as const, Icon: IconProtezioneAcquirente },
        { titleKey: 'gameHome.features.communityGuided' as const, Icon: IconGuidatiCommunity },
      ] as const,
    []
  );
      ...
      <div className="container-content px-4 sm:px-6">
        <div className="grid grid-cols-2 gap-6 lg:grid-cols-4 lg:gap-8">
          {features.map(({ titleKey, Icon }) => (
            <div key={titleKey} className="flex items-center gap-3 text-center sm:text-left">
