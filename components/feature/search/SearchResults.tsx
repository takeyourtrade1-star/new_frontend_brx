        ...
        <div className="hidden md:flex flex-col gap-2 py-2 px-3 border border-gray-200 bg-white mb-3 sm:flex-row sm:flex-wrap sm:items-center sm:justify-between sm:gap-2">
          ...
          <div className="flex w-full min-w-0 flex-col gap-2 sm:w-auto sm:flex-row sm:items-center sm:justify-end sm:gap-3">
            ...
            <div className="hidden md:flex items-center">
              <div className="flex h-[36px] w-[104px] overflow-hidden rounded-full border border-gray-200 bg-[#f2f2f7]">
                <button
                  type="button"
                  onClick={() => setViewMode('list')}
                  aria-label={t('search.viewList')}
                  title={t('search.viewList')}
                  className={`relative z-10 flex h-[36px] w-[52px] items-center justify-center transition-colors ${
                    viewMode === 'list' ? 'bg-orange-50/60 text-[#FF7300]' : 'bg-[#f2f2f7] text-gray-500'
                  }`}
                >
                  {viewMode === 'list' && (
                    <span
                      aria-hidden
                      className="absolute left-0 top-1/2 h-6 w-[3px] -translate-y-1/2 rounded-r bg-[#FF7300]/90 shadow-sm pointer-events-none"
                    />
                  )}
                  <Rows3 className="relative h-4 w-4 pointer-events-none" aria-hidden />
                </button>
                <button
                  type="button"
                  onClick={() => setViewMode('grid')}
                ...
                >
                  ...
                  <Grid2x2 className="relative h-4 w-4 pointer-events-none" aria-hidden />
                </button>
              </div>
            </div>
          </div>
