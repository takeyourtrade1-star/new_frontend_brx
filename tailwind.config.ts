  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        'coin-pop': {
          '0%': { opacity: '0', transform: 'scale(0.3) translateY(6px) rotateY(0deg)' },
          '18%': { opacity: '1', transform: 'scale(1) translateY(-3px) rotateY(180deg)' },
          '42%': { opacity: '1', transform: 'scale(1.06) translateY(-6px) rotateY(360deg)' },
          '64%': { opacity: '1', transform: 'scale(1) translateY(-1px) rotateY(540deg)' },
          '80%': { opacity: '1', transform: 'scale(1.1) translateY(0) rotateY(720deg)' },
          '90%': { opacity: '0.9', transform: 'scale(0.94) translateY(0) rotateY(720deg)' },
          '100%': { opacity: '0', transform: 'scale(0.5) translateY(4px) rotateY(720deg)' },
        },
        'coin-shine': {
          '0%, 18%': { opacity: '0', transform: 'translateX(-4px) rotate(18deg)' },
          '44%': { opacity: '0.9', transform: 'translateX(0) rotate(18deg)' },
