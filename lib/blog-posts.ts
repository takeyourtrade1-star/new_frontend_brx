...
export const BLOG_POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    title: 'Dal Marketplace ai Tornei in un lampo: Ebartex è ancora più fluido',
    excerpt:
      'Accedi una volta e sei pronto a tutto: compra, scambia e gioca senza dover mai reinserire la password.',
    paragraphs: [
      'Muoversi su Ebartex diventa ancora più semplice e immediato. Da oggi basta accedere una sola volta per passare liberamente dal Marketplace alle tue carte, fino ad entrare nei Tornei in un istante.',
      'Niente passaggi a vuoto o schermate di blocco: clicchi su Tornei e sei subito al tavolo di gioco con il tuo profilo, con tutta la protezione e la sicurezza di sempre.',
    ],
